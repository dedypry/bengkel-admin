...
const clientManifest = {
  "src/routes/index.page.tsx": {
    file: "assets/index.page-1e8eb57a.js",
    imports: [
...
async function renderPageRoute(ctx) {
  ...
  const routes = (await import("./assets/virtual_rakkasjs_server-page-routes-8c73cba2.js")).default;
  let {
    url: { pathname }
  } = ctx;
