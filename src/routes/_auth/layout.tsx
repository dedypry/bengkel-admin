...
export default function Layout({ children }: LayoutProps) {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#F8FAFC]">
      ...
      <div className="absolute top-[-15%] left-[-10%] w-[500px] h-[500px] rounded-full bg-blue-400/20 blur-[100px] animate-pulse" />

      {/* Bola Teal/Hijau Toska - Tengah Kanan */}
      <div className="absolute top-[20%] right-[-5%] w-[400px] h-[400px] rounded-full bg-teal-300/15 blur-[80px]" />

      {/* Bola Orange Lembut (Aksen Lampu) - Kiri Bawah */}
      <div className="absolute bottom-[-10%] left-[-5%] w-[450px] h-[450px] rounded-full bg-orange-200/20 blur-[110px]" />

      {/* Bola Ungu Muda - Kanan Bawah */}
      <div className="absolute bottom-[5%] right-[10%] w-[300px] h-[300px] rounded-full bg-indigo-200/20 blur-[90px]" />
